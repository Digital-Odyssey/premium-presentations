  ...
  $.PMFloorPlan.prototype = {
    ...
    _resizeHandler: function() {
      ...
      setTimeout(function() {
        if ($(window).width() < 480) {
          ...
          parent._resizeMobileMarker(
            floorPlanSettings["markerResponsiveSize"],
            floorPlanSettings["markerResponsiveSize"]
          );
    ...
    _showPanels: function() {
      ...
      if (floorPlanSettings["markerType"] == "icon") {
        background =
          "background-image:url(" + floorPlanSettings["markerIcon"] + ");";
      } else {
      ...
      for (var i = 0; i < len; i++) {
        var display = "";
        if (
          floorPlanData[i]["panelVideo"] != "" &&
          !floorPlanSettings["floorplanResponsiveness"]
        ) {
          display =
            '<iframe width="100%" height="' +
            floorPlanSettings["panelHeight"] +
            '" src="//www.youtube.com/embed/' +
            floorPlanData[i]["panelVideo"] +
            '?version=3&hl=en_US&autoplay=0&rel=0" frameborder="0" allowfullscreen></iframe>';
        } else if (
          floorPlanData[i]["panelVideo"] != "" &&
          floorPlanSettings["floorplanResponsiveness"] == 1
        ) {
          display =
            '<iframe width="100%" height="' +
            floorPlanSettings["videoHeight"] +
            '" src="//www.youtube.com/embed/' +
            floorPlanData[i]["panelVideo"] +
            '?version=3&hl=en_US&autoplay=0&rel=0" frameborder="0" allowfullscreen></iframe>';
        ...
        if (showAll) {
          ...
          if (
            floorPlanSettings["panelLayout"] == "pm-lo-1" &&
            !floorPlanSettings["floorplanResponsiveness"]
          ) {
            //Panel Layout 1
            ...
            if (display == "" && floorPlanSettings["panelAutoResize"] == 1) {
              $(".pm_panels_container").append(
                '<div class="pm_panel full" style="border-radius:' +
                  floorPlanSettings["panelBorderRadius"] +
                  'px;" id="panel_' +
                  floorPlanData[i]["markerNumber"] +
                  '" data-marker=\'{"xPos":"' +
                  floorPlanData[i]["markerX"] +
                  '", "yPos":"' +
                  floorPlanData[i]["markerY"] +
                  '", "width":"' +
                  floorPlanSettings["markerSize"] +
                  '", "height":"' +
                  floorPlanSettings["markerSize"] +
                  '", "markerNumber":"' +
                  floorPlanData[i]["markerNumber"] +
                  '", "markerTooltip":"' +
                  floorPlanData[i]["markerTooltip"] +
                  '" }\'><div class="pm_section_info pm_full_width" style="height:' +
                  panelHeight +
                  "px; background-color:" +
                  panelBGColor +
                  ';"><div class="pm_back_to_top">&uarr;</div><ul style="color:' +
                  panelTextColor +
                  ';"><li><div class="marker ' +
                  floorPlanSettings["markerType"] +
                  '" style="width:' +
                  floorPlanSettings["markerSize"] +
                  "px; height:" +
                  floorPlanSettings["markerSize"] +
                  ...
                  background +
                  '"><p style="font-size:' +
                  floorPlanSettings["markerFontSize"] +
                  "px; padding-top:" +
                  floorPlanSettings["markerYPosition"] +
                  "px; color:" +
                  floorPlanSettings["markerFontColor"] +
                  ';">' +
                  floorPlanData[i]["markerNumber"] +
                  '</p></div><div class="section" style="color:' +
                  panelTitleColor +
                  "; font-size:" +
                  panelTitleFontSize +
                  "px; padding-top:" +
                  panelTitleYPosition +
                  'px;">' +
                  floorPlanData[i]["panelTitle"] +
                  '</div></li><li id="panel_info_' +
                  floorPlanData[i]["markerNumber"] +
                  '"></li></ul></div> ' +
                  (floorPlanData[i]["gmapAddress"] != ""
                    ? "" + parent._buildGoogleMap(i) + ""
                    : "") +
                  " </div>"
              );
            } else {
              $(".pm_panels_container").append(
                '<div class="pm_panel full" style="border-radius:' +
                  ...
                  '", "markerTooltip":"' +
                  floorPlanData[i]["markerTooltip"] +
                  '" }\'><div class="pm_section pm_left" style="width:' +
                  sectionWidth +
                  "px; height:" +
                  panelHeight +
                  'px;"> ' +
                  display +
                  ' </div><div class="pm_section_info pm_left" style="width:' +
                  infoWidth +
                  "px; height:" +
                  panelHeight +
                  "px; background-color:" +
            ...
            floorPlanSettings["panelLayout"] == "pm-lo-2" &&
            !floorPlanSettings["floorplanResponsiveness"]
          ) {
            //Panel Layout 2
            ...
            if (display == "" && floorPlanSettings["panelAutoResize"] == 1) {
              ...
              $(".pm_panels_container").append(
                '<div class="pm_panel full" style="border-radius:' +
                  ...
                  '", "markerTooltip":"' +
                  floorPlanData[i]["markerTooltip"] +
                  '" }\'><div class="pm_section pm_right" style="width:' +
                  sectionWidth +
                  "px; height:" +
                  panelHeight +
                  'px;"> ' +
            ...
            floorPlanSettings["panelLayout"] == "pm-lo-3" &&
            !floorPlanSettings["floorplanResponsiveness"]
          ) {
            ...
            $(".pm_panels_container").append(
              '<div class="pm_panel full" style="border-radius:' +
                ...
                "px; background-color:" +
                panelBGColor +
                ';"><div class="pm_back_to_top_absolute">&uarr;</div><ul style="color:' +
                panelTextColor +
                ';"><li><div class="marker ' +
                floorPlanSettings["markerType"] +
                '" style="width:' +
            ...
            floorPlanSettings["panelLayout"] == "pm-lo-4" &&
            !floorPlanSettings["floorplanResponsiveness"]
          ) {
            ...
            $(".pm_panels_container").append(
              '<div class="pm_panel full" style="border-radius:' +
                ...
                '", "markerTooltip":"' +
                floorPlanData[i]["markerTooltip"] +
                '" }\'><div class="pm_section pm_full_width" style="height:' +
                panelHeight +
                'px;"> ' +
                display +
                ' </div><div class="pm_back_to_top_absolute">&uarr;</div> ' +
                (floorPlanData[i]["gmapAddress"] != ""
                  ? "" + parent._buildGoogleMap(i) + ""
                  : "") +
                " </div>"
            ...
            floorPlanSettings["panelLayout"] == "pm-lo-5" &&
            !floorPlanSettings["floorplanResponsiveness"]
          ) {
            //Panel Layout 5 - no panels
            $(".pm_panels_container").append(
              '<div class="pm_panel full" style="display:none;" id="panel_' +
                floorPlanData[i]["markerNumber"] +
                '" data-marker=\'{"xPos":"' +
                floorPlanData[i]["markerX"] +
                '", "yPos":"' +
                ...
                '" }\'><div class="pm_section pm_full_width" style="height:' +
                panelHeight +
                'px;"></div><div class="pm_back_to_top">&uarr;</div> ' +
                (floorPlanData[i]["gmapAddress"] != ""
                  ? "" + parent._buildGoogleMap(i) + ""
                  : "") +
                " </div>"
            ...
            $(".pm_panels_container").append(
              '<div class="pm_panel pm_panel_responsive" style="border-radius:' +
                floorPlanSettings["panelBorderRadius"] +
                'px;" id="panel_' +
                floorPlanData[i]["markerNumber"] +
                '" data-marker=\'{"xPos":"' +
                ...
                '", "markerTooltip":"' +
                floorPlanData[i]["markerTooltip"] +
                '" }\'><div class="pm_section_info" style="width:100%; height:auto !important; background-color:' +
                panelBGColor +
                ';"><div class="pm_back_to_top">&uarr;</div><ul style="color:' +
                panelTextColor +
                '; margin-bottom:0px !important;"><li><div class="marker ' +
                floorPlanSettings["markerType"] +
                '" style="width:' +
                floorPlanSettings["markerSize"] +
                "px; height:" +
                ...
                '</div></li><li id="panel_info_' +
                floorPlanData[i]["markerNumber"] +
                '"></li></ul></div><div class="pm_section" style="width:100%; height:auto !important;">' +
                display +
                "</div> " +
                (floorPlanData[i]["gmapAddress"] != ""
                  ? "" + parent._buildGoogleMap(i) + ""
          ...
          if (floorPlanSettings["panelLayout"] != "pm-lo-4") {
            parent._addPanelInfo(
              floorPlanData[i]["panelDesc"],
              "#panel_info_" + floorPlanData[i]["markerNumber"]
            );
          }
        } else {
          ...
          if (
            ...
            if (display == "" && floorPlanSettings["panelAutoResize"] == 1) {
              $(".pm_panels_container").append(
                '<div class="pm_panel" style="border-radius:' +
                  floorPlanSettings["panelBorderRadius"] +
                  'px;" id="panel_' +
                  floorPlanData[i]["markerNumber"] +
                  '" data-marker=\'{"xPos":"' +
            ...
            //Panel Layout 5 - no panels
            $(".pm_panels_container").append(
              '<div class="pm_panel" style="display:none;" id="panel_' +
                floorPlanData[i]["markerNumber"] +
                '" data-marker=\'{"xPos":"' +
                floorPlanData[i]["markerX"] +
                '", "yPos":"' +
      ...
      $(".pm_panel")
        .each(function(index, obj) {
          ...
          if (floorPlanSettings["floorplanResponsiveness"]) {
            ...
            var markerX =
              ($obj.data("marker").xPos / floorPlanSettings["floorplanWidth"]) *
                100 +
              "%";
            var markerY =
              ($obj.data("marker").yPos /
                floorPlanSettings["floorplanHeight"]) *
                100 +
              "%";
          } else {
          ...
          if (floorPlanSettings["markerType"] == "icon") {
            ...
            if (
              ...
              background =
                "background-color:" + floorPlanSettings["markerActiveColor"];
            } else {
              background =
                "background-color:" + floorPlanSettings["markerColor"];
            }
          }
          ...
          if (
            ...
            //First Marker
            var marker =
              '<div class="pm_floorplan_marker ' +
              floorPlanSettings["markerType"] +
              " active " +
              (floorPlanSettings["markerAnimation"] == 1 ? "pm_animate" : "") +
              '" id="marker_' +
              markerNumber +
              '" style="top:' +
              markerY +
        ...
        .promise()
        .done(function() {
          parent._activateMarkers();
        }); //activate markers after all panel data has loaded and is displayed on screen
    },
    ...
    _activateMarkers: function() {
      ...
      $(
        ".pm_floorplan_container .pm_markers_container .pm_floorplan_marker"
      ).each(function(index, obj) {
        var $obj = $(obj);
          ...
          $obj.hover(
            function() {
              if (!$(this).hasClass("active")) {
                $(this).css({
                  "background-color": floorPlanSettings["markerHoverColor"]
                });
              }
            },
            function() {
            ...
            if (showAll) {
              ...
              if (
                ...
                $("html, body").animate(
                  {
                    scrollTop:
                      $("#pm_floorplan_container").offset().top +
                      panelHeight +
                      40 //add some extra spacing
                  },
                  1000
                );
              }
    ...
    _toolTip: function(toolTipData, el) {
      ...
      $el.mousemove(function(e) {
        ...
        var x =
          mouseX -
          $(".pm_floorplan_container").offset().left +
          toolTipWidth +
          70;
        ...
        if (x > contentWidth) {
          ...
          $("#pm_marker_tooltip")
            ...
            .css("left", mouseX + -220 + "px"); //flip position
        } else {
          //console.log('x < toolTipWidth');
          $("#pm_marker_tooltip")
            .css("top", mouseY - yOffset + "px")
            .css("left", mouseX + xOffset + "px"); //start position
        }
      });
    }, //end of toolTip
    ...
    _buildGoogleMap: function(indexNum) {
      ...
      var $map =
        '<div class="panel_google_map_title" style="background-color:' +
        floorPlanSettings["googleMapBtnColor"] +
        "; color:" +
        floorPlanSettings["googleMapBtnTextColor"] +
        ';">Loading Map...</div><div class="panel_block maps"><div class="content"><div class="map_canvas" style="height:' +
        floorPlanSettings["googleMapHeight"] +
        'px;"><div class="infotext"><div class="location">' +
        floorPlanData[indexNum]["gmapTitle"] +
        '</div><div class="address">' +
        floorPlanData[indexNum]["gmapAddress"] +
        '</div><div class="city">' +
        floorPlanData[indexNum]["gmapCity"] +
        '</div><div class="state">' +
        floorPlanData[indexNum]["gmapState"] +
        '</div><div class="zip">' +
        floorPlanData[indexNum]["gmapZip"] +
        '</div><div class="country">' +
        floorPlanData[indexNum]["gmapCountry"] +
        '</div><div class="phone">' +
        floorPlanData[indexNum]["gmapPhone"] +
        '</div><div class="zoom">' +
        floorPlanSettings["googleMapZoomLevel"] +
        "</div></div></div></div></div>";
    ...
    _createGoogleMap: function(index, element) {
      ...
      var content =
        "<strong>" +
        $infotext.children(".location").text() +
        "</strong><br />" +
        $infotext.children(".address").text() +
        "<br />" +
        $infotext.children(".city").text() +
      ...
      geocoder.geocode({ address: address }, function(results, status) {
        if (status == google.maps.GeocoderStatus.OK) {
          ...
          alert(
            "The address could not be found for the following reason: " + status
          );
        }
      });
    },
  ...
  $.fn.PMFloorPlan = function(options) {
    if (typeof options === "string") {
      ...
      this.each(function() {
        ...
        if (!instance) {
          logError(
            "cannot call methods on PMFloorPlan prior to initialization; " +
